...
-export_type([any_tuple/0, empty_tuple/0, fully_typed_tuple/0, partially_typed_tuple/0]).
...
is_tuple_test_() ->
    [?_assertEqual(true, (istype({}, tuple()))), ?_assertEqual(true, (istype({atom}, tuple()))), ?_assertEqual(false, (istype([], tuple())))].

is_empty_tuple_test_() ->
    [?_assertEqual(true, (istype({}, {}))), ?_assertEqual(false, (istype({atom}, {}))), ?_assertEqual(false, (istype([], {})))].

is_aliased_tuple_test_() ->
    [?_assertEqual(true, (istype({}, any_tuple()))), ?_assertEqual(true, (istype({atom}, any_tuple()))),
     ?_assertEqual(false, (istype([], any_tuple()))), ?_assertEqual(true, (istype({}, empty_tuple()))),
     ?_assertEqual(false, (istype({atom}, empty_tuple()))), ?_assertEqual(false, (istype([], empty_tuple())))].

is_fully_typed_tuple_test_() ->
    [?_assertEqual(false, (istype(rv([]), fully_typed_tuple()))), ?_assertEqual(false, (istype(rv({}), fully_typed_tuple()))),
...
is_partially_typed_tuple_test_() ->
    [?_assertEqual(false, (istype(rv([]), partially_typed_tuple()))), ?_assertEqual(false, (istype(rv({}), partially_typed_tuple()))),
     ?_assertEqual(true, (istype({atom, binary}, partially_typed_tuple()))),
     ?_assertEqual(true, (istype({atom, <<"binary">>}, partially_typed_tuple()))),
     ?_assertEqual(false, (istype({<<"binary">>, atom}, partially_typed_tuple())))].

to_tuple_test_() ->
    [?_assertEqual({}, (totype({}, tuple()))), ?_assertEqual({}, (totype([], tuple()))),
...
to_aliased_tuple_test_() ->
    [?_assertEqual({}, (totype({}, any_tuple()))), ?_assertEqual({}, (totype([], any_tuple()))),
...
to_empty_tuple_test_() ->
    [?_assertEqual({}, (totype({}, empty_tuple()))), ?_assertEqual({}, (totype([], empty_tuple()))),
